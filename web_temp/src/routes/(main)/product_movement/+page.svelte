            ...
            <div class="grid gap-3 font-roboto font-semibold">
              ...
              <div class="">
                ...
                <div class="flex items-center justify-start">
                  <button type="button" 
                  on:click={() => exportPDF(window.location.origin+`/print_stock_card/${$uri}/${product.ProductDetails.product_detail_id}/-`, `StockCard_${product.ProductDetails.product_detail_id}_AllSW`, 190)}
