...
<div class="flex h-screen">
    ...
    <div class="w-5/12 flex flex-col bg-darkGray h-full border-l-8 border-l-peach">
        <div class="flex justify-around text-white font-semibold mt-4 mb-2">
            <span class="mx-2"><span><i class="fa-solid fa-dollar-sign mr-2" style="color: #F2AA7E;"></i></span>Payment</span>
            <span class="mx-2"><span><i class="fa-solid fa-list mr-2" style="color: #F2AA7E;"></i></span>View Transaction List</span>
            <span class="mx-2 flex"><span class="mr-2"><svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
        ...
        <div class="flex flex-col items-center ml-6 h-3/6 overflow-auto">
            <!-- Item -->
        ...
        <div class="h-2/5 flex bg-gray-300">
            <button class="font-bold bg-peach2 text-darkGray text-6xl h-full w-1/2">PAY</button>
            <div class="grid grid-cols-4 gap-0.5 w-1/2 font-bold">
                <button class="bg-white text-darkGray text-4xl">7</button>
                <button class="bg-white text-darkGray text-4xl">8</button>
                <button class="bg-white text-darkGray text-4xl">9</button>
                <button class="bg-white text-darkGray text-4xl row-span-2"><i class="fa-solid fa-chevron-up"></i></button>
                <button class="bg-white text-darkGray text-4xl">4</button>
                <button class="bg-white text-darkGray text-4xl">5</button>
                <button class="bg-white text-darkGray text-4xl">6</button>
                <button class="bg-white text-darkGray text-4xl">1</button>
                <button class="bg-white text-darkGray text-4xl">2</button>
                <button class="bg-white text-darkGray text-4xl">3</button>
                <button class="bg-white text-darkGray text-4xl row-span-2"><i class="fa-solid fa-chevron-down"></i></button>
                <button class="bg-white text-darkGray text-4xl">.</button>
                <button class="bg-white text-darkGray text-4xl">0</button>
                <button class="bg-white text-darkGray text-4xl"><i class="fa-solid fa-delete-left"></i></button>
            </div>
        </div>
    </div>
</div>