    ...
    <TaskModal open={showModal} onClose={closeModal} color={"#3d4c52"}>
      ...
      <form class=" mt-4 p-4 md:p-5">
          <div class="grid gap-3 font-roboto font-semibold">
            ...
            <div class="">
              <button 
                on:click={() => exportPDF(window.location.origin+`/print_stock_card/${$uri}/${product.ProductDetails.product_detail_id}/${store_warehouse_id}`, `StockCard_${product.ProductDetails.product_detail_id}_${sw_name_print}`, 190)}
