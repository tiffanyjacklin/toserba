...
<div class="flex h-screen">
    ...
    <div class="w-1/2 h-full bg-darkGray border-l-8 border-l-peach">
            ...
            <button on:click={() => viewPDF(window.location.origin+`/printreceipt/${$uri}/${transaction_struk.transaction_id}`, `Transaction_#`+transaction_struk.transaction_id+`_PrintedOn${getFormattedDateForPrint()}`, 190)} class="w-full h-3/6 bg-gray-100 mt-16 flex flex-col items-center justify-center">
