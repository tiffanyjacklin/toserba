    ...
    <div class="p-6 rounded-2xl w-[32rem] bg-[#3d4c52] shadow-[0_6px_0px_0px_rgba(242,176,130,1)]">
      <div class="flex flex-col mb-4 rounded font-roboto font-medium">
         ...
         <div class="flex items-center justify-center  pt-12 ">
            <button type="button" data-modal-target="crud-modal" data-modal-toggle="crud-modal" class="h-10 w-1/2 px-6 text-xl inline-flex items-center justify-center font-bold rounded-md bg-[#f7d4b2] hover:bg-[#f2b082] text-[#3d4c52] hover:shadow-2xl">
                  New Session
            </button>
         </div>
   ...
   <div class="relative p-4 w-full max-w-md max-h-full">
       ...
       <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
           ...
           <form class="p-4 md:p-5">
               <div class="grid gap-4 mb-4 grid-cols-2 font-roboto">
                  <div class="flex justify-between">
                     <div class="col-span-2 sm:col-span-1 text-[#f7d4b2]">
                        Cashier
                     </div>
                     <div class="col-span-2 sm:col-span-1 text-white">
                        Budi
                     </div>
                  </div>
                  <div class="flex justify-between">
                  ...
                  <div class="flex justify-between">
                     ...
                     <div class="col-span-2 sm:col-span-1 ">
                        <input type="text" name="opening_cash" id="opening_cash" class="text-[#3d4c52] bg-white text-sm rounded-lg focus:ring-[#f7d4b2] focus:border-[#f7d4b2] block w-full p-2.5" placeholder="Rp 400,000.00" required="">
                     </div>
                  </div>
                  <div class="flex justify-between">
                     <div class="col-span-2 sm:col-span-1 text-[#f7d4b2]">
                     ...
                     <div class="col-span-2 sm:col-span-1 text-white">
                        <textarea id="additional_notes" rows="4" class="text-[#3d4c52] bg-white text-sm rounded-lg focus:ring-[#f7d4b2] focus:border-[#f7d4b2] w-full" placeholder="Session starting earlier than expected."></textarea>                    
                     </div>
                  </div>
