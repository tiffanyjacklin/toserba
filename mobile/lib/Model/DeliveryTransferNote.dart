class FetchDeliveryTransferNotes {
  int? status;
  String? message;
  List<Data>? data;

  FetchDeliveryTransferNotes({this.status, this.message, this.data});

  FetchDeliveryTransferNotes.fromJson(Map<String, dynamic> json) {
    status = json['status'];
